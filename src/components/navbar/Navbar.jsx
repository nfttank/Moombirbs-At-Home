    ...
    return (
        <div className="og__navbar">
            ...
            <div className="og__navbar-sign">
                ...
                {props.data.openMinting && props.data.connected === true &&
                ...
                {props.data.openMinting && <a href={props.data.looksRareUrl} target="_blank" rel="noopener noreferrer" title="LooksRare">L</a>}
                {props.data.openMinting && <a href={props.data.openSeaStorefrontUrl} target="_blank" rel="noopener noreferrer" title="OpenSea">O</a>}
